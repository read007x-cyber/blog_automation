...
output_dir = "/Users/jsh/main/output/클로드 코드의 핵심 기능 5가지/images"
...
tasks = [
    ...
    ("body_1.png", html_body_1, 900, 550),
    ("body_2.png", html_body_2, 900, 550),
    ("body_3.png", html_body_3, 900, 550),
    ("body_4.png", html_body_4, 900, 550),
]

async def main():
    async with async_playwright() as p:
        browser = await p.chromium.launch()
        for filename, html_content, w, h in tasks:
