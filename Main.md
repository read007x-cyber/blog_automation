...
## 1. 프로젝트 목적
사용자가 제시한 주제에 대해 웹 리서치부터 포스팅 집필, 이미지 생성, 최종 HTML 변환까지 자동 수행하는 블로그 시스템

***

## 2. 폴더 구조
* agents/ : 서브 에이전트 지침서 디렉토리 (researcher, writer, image_maker, assembler)
* guides/ : 작성 규칙 및 디자인 가이드 문서 디렉토리
* output/ : 주제별 결과물 저장 디렉토리 ([주제]/research.md, draft.md, images/, final.md, final.html)
